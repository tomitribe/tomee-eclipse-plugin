...
import com.tomitribe.eclipse.tomee.server.internal.xml.server40.Connector;
import com.tomitribe.eclipse.tomee.server.internal.xml.server40.Context;
import com.tomitribe.eclipse.tomee.server.internal.xml.server40.Listener;
...
import com.tomitribe.eclipse.tomee.server.internal.xml.server40.Service;
/**
 * Tomcat v7.0 server configuration.
 */
public class TomEE15Configuration extends TomcatConfiguration {
	 ...
	 * @param path a path
	 */
	public TomEE15Configuration(IFolder path) {
		super(path);
	}
	...
	public void load(IPath path, IProgressMonitor monitor) throws CoreException {
		try {
			...
			serverFactory.setPackageName("com.tomitribe.eclipse.tomee.server.internal.xml.server40");
